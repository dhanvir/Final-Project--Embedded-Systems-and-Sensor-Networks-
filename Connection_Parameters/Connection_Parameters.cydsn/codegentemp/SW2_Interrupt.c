...
{
    CyRamVectors[CYINT_IRQ_BASE + SW2_Interrupt__INTC_NUMBER] = address;
}
...
{
    return CyRamVectors[CYINT_IRQ_BASE + SW2_Interrupt__INTC_NUMBER];
}
...
*
*   Note calling SW2_Interrupt_Start or SW2_Interrupt_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after SW2_Interrupt_Start or SW2_Interrupt_StartEx has been called. 
...
void SW2_Interrupt_SetPriority(uint8 priority)
{
    ...
    uint32 priorityOffset = ((SW2_Interrupt__INTC_NUMBER % 4u) * 8u) + 6u;
    
	interruptState = CyEnterCriticalSection();
    *SW2_Interrupt_INTC_PRIOR = (*SW2_Interrupt_INTC_PRIOR & (uint32)(~SW2_Interrupt__INTC_PRIOR_MASK)) |
...
uint8 SW2_Interrupt_GetPriority(void)
{
    ...
    priority = (*SW2_Interrupt_INTC_PRIOR & SW2_Interrupt__INTC_PRIOR_MASK) >> priorityOffset;
